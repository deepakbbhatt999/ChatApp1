...
class Send(threading.Thread):
    ...
    def run(self):
        ...
        Typing '/x' will close the connection and exit the application.
        """
        while True:
...
class Receive(threading.Thread):
    """
    Receive thread is used to listens incoming messages from the server.
    Attributes:
        sock (socket.socket): The connected socket object.
        name (str): The username provided by the user.
    ...
    def run(self):
        ...
        Always listens to messages from other users until either end has closed the socket.
        """
        while True:
...
class Client:
    ...
    def start(self):
        """
        Establishes the client-server connection. Gathers user input for the name,
        creates and starts the Send and Receive threads, and notifies other users
        Returns:
        ...
        print("\rAll set to Chat! Leave the chatroom anytime by typing '/x'\n")
        print('{}: '.format(self.name), end = '')
    ...
    def send(self, text_input):
        """
        Sends text_input message from the GUI to other users.
        Typing '/x' will close the connection and exit the application.
        Args:
